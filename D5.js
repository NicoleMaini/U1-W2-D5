...
/* ESERCIZIO 7
    ...
    nuovo array "justTrims", sotto definito.
*/
const justTrims = []
...
for(let i = 0; i < cars.length; i++){
  let colorArr = cars[i].color;
    if(colorArr[0].toLocaleLowerCase() === "b"){
      console.log(cars[i], "Fizz");
    } else {
      console.log(cars[i],"Buzz");
    }
  };
